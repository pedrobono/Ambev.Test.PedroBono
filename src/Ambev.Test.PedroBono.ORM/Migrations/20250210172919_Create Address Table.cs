        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lat = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: true),
                    Long = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: true),
